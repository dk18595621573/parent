 ...
 * 枚举类型的转换器
 */
public class BaseEnumTypeHandlerForExtendsBaseEnum<E extends Enum<?> & ConvertEnum> extends BaseTypeHandler<ConvertEnum> {
    private Class<E> type;
    private E[] enums;

    public BaseEnumTypeHandlerForExtendsBaseEnum(Class<E> type) {
        if (type == null) {
    ...
    @Override
    public void setNonNullParameter(PreparedStatement preparedStatement, int i, ConvertEnum baseEnum,
