...
import com.cloud.framework.lock.XLockInterceptor;
import com.cloud.framework.lock.XLockSpelResolver;
import com.cloud.framework.lock.annotation.EnableXLock;
import com.cloud.framework.lock.exception.UnknownLoadBalancerException;
import com.cloud.framework.lock.exception.UnknownReadModeException;
import com.cloud.framework.lock.exception.UnknownSubscriptionModeException;
import com.cloud.framework.lock.lock.FairLock;
import com.cloud.framework.lock.lock.LockFactory;
import com.cloud.framework.lock.lock.MultiLock;
import com.cloud.framework.lock.lock.ReadLock;
import com.cloud.framework.lock.lock.RedLock;
import com.cloud.framework.lock.lock.ReentrantLock;
import com.cloud.framework.lock.lock.WriteLock;
