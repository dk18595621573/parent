package com.cloud.component.shadow;
...
import com.cloud.component.shadow.bean.request.BaseRequest;
import com.cloud.component.shadow.bean.request.task.TaskQueryRequest;
import com.cloud.component.shadow.bean.request.task.TaskStartRequest;
import com.cloud.component.shadow.bean.request.task.TaskStopRequest;
import com.cloud.component.shadow.bean.request.token.TokenCreateRequest;
import com.cloud.component.shadow.bean.response.BaseResponse;
import com.cloud.component.shadow.bean.response.ShadowBotResponse;
import com.cloud.component.shadow.bean.response.task.TaskQueryResponse;
import com.cloud.component.shadow.bean.response.task.TaskStartResponse;
import com.cloud.component.shadow.bean.response.task.TaskStopResponse;
import com.cloud.component.shadow.bean.response.token.TokenCreateResponse;
import com.cloud.component.shadow.consts.ShadowBotConst;
import com.cloud.component.shadow.exception.ShadowBotApiException;
import com.cloud.component.shadow.exception.ShadowBotRuntimeException;
...
public class ShadowBotClient {
    ...
    private final ShadowBotProperties shadowBotProperties;
    ...
    private <T extends BaseResponse> T executeInternal(final BaseRequest<T> request) throws ShadowBotApiException {
        // 请求地址
        String url = shadowBotProperties.getUrl().concat(request.getApiUrl());
        log.info("【请求地址】：{}", url);
        // 发送请求
        String response;
        ...
        try {
            ...
            shadowBotResponse = JsonUtil.parse(response, ShadowBotResponse.class);
        } catch (Exception e) {
            log.error("调用影刀平台接口异常：{}", ExceptionUtils.getStackTrace(e));
    ...
    private String getToken() {
        ...
        request.setAccessKeyId(shadowBotProperties.getAccessKeyId());
        request.setAccessKeySecret(shadowBotProperties.getAccessKeySecret());
        // 请求地址
        String url = shadowBotProperties.getUrl().concat(request.getApiUrl());
        // 发送请求
        ...
        // 解析响应参数
        ShadowBotResponse shadowBotResponse = JsonUtil.parse(response, ShadowBotResponse.class);
