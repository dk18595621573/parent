...
import com.cloud.core.manager.AsyncExecute;
...
public class AsyncFactory {
     ...
     * @return 任务task
     */
    public static AsyncExecute recordLogininfor(final String username, final String status, final String message, final BaseRequestInfo requestInfo,
                                                final Object... args) {
        return () -> {
            // 封装对象
     ...
     * @return 任务task
     */
    public static AsyncExecute recordOper(final OperateLog operLog) {
        return () -> {
            // 远程查询操作地点
