...
public class AddressUtils {
     ...
     * @return
     */
    public static Address addressFormat(String address) {
        ...
        //省份
        String province = addresss.get("province").replace("省","");
        //市
        String city = addresss.get("city").replace("市","");
        //区县
        ...
        result.setTown(town);
        result.setDetail(detailAddress.toString().replaceAll("\\s+",""));
        result.setDetailFormat(detailAddress.toString());
